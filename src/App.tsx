...
const RecruiterDashboard = lazyWithRetry(() => import('@/pages/RecruiterDashboard'))
...
const RecruiterProfile = lazyWithRetry(() => import('@/pages/RecruiterProfile'))
const FindProfessionals = lazyWithRetry(() => import('@/pages/FindProfessionals'))
const ProfessionalPublic = lazyWithRetry(() => import('@/pages/ProfessionalPublic'))
...
const BrowseJobs = lazyWithRetry(() => import('@/pages/RecruiterJobs').then((m) => ({ default: m.BrowseJobsView })))
const TalentSearch = lazyWithRetry(() => import('@/pages/TalentSearch'))
const Messages = lazyWithRetry(() => import('@/pages/Messages'))
const Analytics = lazyWithRetry(() => import('@/pages/Analytics'))
const Settings = lazyWithRetry(() => import('@/pages/Settings'))
const Help = lazyWithRetry(() => import('@/pages/Help'))
const AdminShell = lazyWithRetry(() => import('@/pages/admin/AdminShell'))
