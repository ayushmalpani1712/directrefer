      ...
      <div className="min-h-screen bg-background px-4 py-8 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-3xl space-y-8">
          ...
          <div className="text-center space-y-4">
            <h1 className="font-display text-3xl font-bold tracking-tight">Company Not Found</h1>
    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="mx-auto max-w-5xl px-4 py-8 sm:px-6 lg:px-8">
        ...
        <section className="mb-12 rounded-xl border border-border bg-muted/30 p-8 text-center space-y-4">
          <h2 className="text-2xl font-bold tracking-tight">Ready to Get Referred at {companyData.name}?</h2>
        ...
        <section className="mb-12 space-y-6">
          <h2 className="text-2xl font-bold tracking-tight">Other Companies</h2>
          <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-3 items-stretch">
            {relatedCompanies.map(c => (
              <Link
                key={c.slug}
                to={`/referral/${c.slug}`}
                className="flex items-center gap-3 rounded-xl border border-border p-4 hover:bg-muted/50 transition-colors h-full"
              >
