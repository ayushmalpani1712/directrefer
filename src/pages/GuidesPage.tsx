...
const GUIDES: Guide[] = [
  {
    ...
    content: [
      ...
      'Step 1: Complete your profile. Make sure your skills, experience, and target roles are up to date. Professionals want to see a complete profile before deciding to refer you.',
      'Step 2: Find the right professional. Look for someone who works at your target company and role. The more relevant their position, the stronger the referral.',
      ...
      'Step 4: Follow up respectfully. If you do not hear back in 5-7 days, send a polite follow-up. Professionals are busy professionals — be patient.',
  ...
  },
  {
    ...
    title: 'Referral Request Best Practices: What Professionals Actually Want to See',
    description: 'Learn what makes a referral request stand out from the hundreds of cold messages professionals receive every month.',
    readTime: '4 min read',
    category: 'Best Practices',
    content: [
      'Professionals receive dozens of requests every month. Here is what makes one stand out.',
      ...
      'Keep it short. Professionals are busy. Your request should be 3-4 sentences max. Respect their time.',
      'Attach your resume. Make it easy for them to assess your fit. PDF format, one page, clear formatting.',
      'Do not follow up more than once. If you do not hear back after one follow-up, move on. There are other professionals.',
    ],
  },
  {
  ...
  {
    slug: 'how-to-be-a-good-professional',
    title: 'How to Be a Good Professional: A Guide for Professionals',
    ...
    content: [
      'Being a professional is one of the most impactful things you can do for your community. Here is how to do it well.',
  ...
  },
  {
    ...
    content: [
      ...
      'Timing: The best time to request a referral is Monday-Wednesday mornings. Professionals are most responsive early in the week.',
    ],
  },
  {
    slug: 'referral-request-email-templates',
    title: '5 Referral Request Templates That Actually Get Responses',
    description: 'Copy-paste templates for LinkedIn messages, emails, and DirectRefer requests that professionals actually respond to.',
    readTime: '3 min read',
    category: 'Templates',
    content: [
