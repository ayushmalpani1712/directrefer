    ...
    return (
      <div className="min-h-screen bg-background">
        ...
        <article className="mx-auto max-w-3xl px-4 py-12">
          ...
          <h1 className="mt-3 text-3xl font-bold sm:text-4xl">{guide.title}</h1>
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <section className="px-4 py-16 text-center">
        <h1 className="text-3xl font-bold sm:text-5xl">Career & Referral Guides</h1>
          ...
          <div key={cat} className="mb-10">
            ...
            <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
              {GUIDES.filter(g => g.category === cat).map(guide => (
                <Link key={guide.slug} to={`/guides/${guide.slug}`} className="group rounded-xl border border-border/50 bg-card p-5 shadow-soft hover:shadow-md transition-shadow">
