...
import { LayoutDashboard, Users, ShieldCheck, BarChart3, Settings, History, Flag, BadgeCheck, TrendingUp, Send, ClipboardList, Star, Coins } from 'lucide-react'
...
const NAV_ITEMS = [
  ...
  { to: '/admin/incentives', label: 'Incentives', icon: Coins },
