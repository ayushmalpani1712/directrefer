...
import { getMessagesPath, ROLE_ROUTE, getRoleFromPath, profileUrl } from '@/data/constants'
            ...
            <CardContent className="pt-2">
              ...
              <LazyResponsiveContainer width="100%" height={160}>
                <LazyBarChart data={proResponseTime} margin={{ top: 8, right: 8, left: -24, bottom: 0 }}>
                  ...
                  <LazyBar dataKey="hours" radius={[5, 5, 0, 0]} fill="hsl(var(--primary))" name="Hours to reply" />
                </LazyBarChart>
              </LazyResponsiveContainer>
              </div>
