    ...
    return (
      <div className="min-h-screen bg-background">
        ...
        <article className="mx-auto max-w-3xl px-4 py-12">
          ...
          <h1 className="mt-3 text-3xl font-bold sm:text-4xl">{story.name} — {story.role}</h1>
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <section className="px-4 py-16 text-center">
        <h1 className="text-3xl font-bold sm:text-5xl">Success Stories</h1>
      ...
      <section className="mx-auto max-w-5xl px-4 pb-16">
        <div className="grid gap-6 sm:grid-cols-2">
          {STORIES.map(story => (
            <Link key={story.slug} to={`/success-stories/${story.slug}`} className="group rounded-xl border border-border/50 bg-card p-6 shadow-soft hover:shadow-md transition-shadow">
              <div className="flex items-center gap-2 text-xs text-muted-foreground">
                <Building2 className="h-3.5 w-3.5" /> {story.company}
              </div>
